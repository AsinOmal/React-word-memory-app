...
//? Takes a timestamp in ms and calculates how much time is left until 24 hours after that timestamp. Returns rem time in ms
...
//? Converts a millisecond value into hours, minutes, and seconds
...
//? Builds list of words up to a given study day.
...
//? Counts the total unique words studied up to a given day.
...
//? Compares some score a with the total number of words up to the day. 
...
//? Checks if a word has already been studied before the given day.
...
//? Calculates the average number of times each word has been repeated up to that day.
...
//? Returns the word and its definition at a given index from WORDS
...
//? Creates a learning schedule for all words, spreading them out across days using spaced repetition
...
//! Object.keys(WORDS).length = the total number of words in that dictionary.
//? generateDynamicSpacedRepetitionSchedule() creates a study plan that tells you which word 
//? -indexes to study or review on each day.

//! PLAN is the resulting schedule. It's basically a mapping of day -> list of word indexes.

// PLAN = {
//  1: [0,1,2], //! On Day 1, study words 0,1,2
//  2: [3,4,0], //! On Dat 2, study words 3, 4 + review word 0
//  3: [5,1],   //! On Day 3, new word 5 + review word 1
// }